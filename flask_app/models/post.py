...
class Post:
    ...
    #     #^^^ same as this_post = Post(results[0])
    #     data={
    ...
    #             }
    #     this_owner=user.User(data)
    #     #^^^ This will create the owner or "user" object
    #     this_post.owner=this_owner
    #     #^^^ This will add the "this_owner" object to the "this_post" object in the key of "owner"
    #     return this_post
    #     #^^^ This returns 
